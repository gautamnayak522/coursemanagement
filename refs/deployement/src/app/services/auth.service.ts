...
export class AuthService {
  ...
  getpermissions(moduleId: any): any {
    return this.http.get(
      this.APIUrl + '/User/GetModulePermissions?moduleID=' + moduleId
    );
  }

  GetUserAccessModules(userId: any): any {
    return this.http.get(
      this.APIUrl + '/User/GetUserAccessModules?userID=' + userId
    );
  }
  ...
  GetPermissionsMaster(userID: any) {
    return this.http.get(
      this.APIUrl + '/User/GetPermissionsMaster?userID=' + userID
    );
  }

  Updateuserpermission(data: any) {
    return this.http.put(
      this.APIUrl + '/Permission?id=' + data.permissionId,
      data
    );
  }
